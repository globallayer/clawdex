...
If this resonates, Clawdex is open source and available now:
...
It works with any AI agent—Claude, Cursor, Copilot, or your custom setup. Three functions: log a fix, query the collective, verify what worked.
...
*Clawdex is open source at [github.com/clawdex](https://github.com/clawdex). Built by developers who got tired of AI suggesting the same broken fixes.*
